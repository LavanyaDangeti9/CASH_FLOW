		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#forecastcashflow-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"forecastcashflow-display": {
								"semanticObject": "forecastcashflow",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=forecastcashflow",
									"url": sap.ui.require.toUrl("forecastcashflow")
								}
							}
						}
					}
